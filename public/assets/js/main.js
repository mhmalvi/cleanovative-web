...
$(function () {
    ...
    if (subMenu.length) {
        subMenu
            ...
            .children("a")
            .append(function () {
                return '<button class="sub-nav-toggler"> <i class="bi bi-arrow-down-short"></i> <i class="bi bi-arrow-down-short"></i> </button>';
            });
    ...
    heroSlide.slick({
        ...
        slidesToScroll: 1,
        prevArrow:
            '<span class="slick-arrow prev-arrow"><i class="bi bi-chevron-left"></i></span>',
        nextArrow:
            '<span class="slick-arrow next-arrow"><i class="bi bi-chevron-right"></i></span>',
        responsive: [
            {
                breakpoint: 767,
                settings: {
    ...
    $(".team-loop .single-member-box").on("mouseenter", function () {
        $(this).find(".social-icons").slideDown(300);
    });
    $(".team-loop .single-member-box").on("mouseleave", function () {
        $(this).find(".social-icons").slideUp(300);
    });
    ...
    $(".project-loop .single-project-box").on("mouseenter", function () {
        $(this).find(".read-more-btn, .hide-text").slideDown(300);
    });
    $(".project-loop .single-project-box").on("mouseleave", function () {
        $(this).find(".read-more-btn, .hide-text").slideUp(300);
    });
