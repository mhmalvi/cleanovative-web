<div class="bg-theme-extra-light pt-100 pb-100">
    <div class="container">
        <div class="pb-50 text-center">
            <h2>Give Your Home That Extra Shine</h2>
            <p>Simply add extras to your cleaning service whenever they are required.</p>
        </div>
        <div class="row px-3">
            ...
            <div class="col-6 col-md-2 my-2">
                <div class="text-center">
                    <div class="border rounded p-3 bg-light shadow-sm">
                        <img src="{{asset('images/icons/oven.png')}}" alt="" class="img-fluid">
                    </div>
                    Inside Oven
                </div>
            </div>
            ...
            <div class="col-6 col-md-2 my-2">
                <div class="text-center">
                    <div class="border rounded p-3 bg-light shadow-sm">
                        <img src="{{asset('images/icons/mansory.png')}}" alt="" class="img-fluid">
                    </div>
                    Spot Clean Walls (1-3 Bedroom)
                </div>
            </div>
            <div class="col-6 col-md-2 my-2">
                <div class="text-center">
