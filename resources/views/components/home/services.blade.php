            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                <div class="single-service active">
                    ...
                    <div class="service-content">
                        ...
                        <p>
                            Moving in-or-out of houses? Looking to secure a strong return on your bond? Don’t stress, You’ve come to the right spot. Allow us to handle ... see more
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mx-auto wow fadeInRight" data-wow-delay=".7s">
                <div class=" single-service">
                    ...
                    <div class="service-content">
                        ...
                        <p>
                            A lot of time is spent at work, and significant meetings are most likely held there. It is critical to maintain the cleanliness of the office ... see more
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mx-auto wow fadeInRight" data-wow-delay=".7s">
                <div class=" single-service">
                    ...
                    <div class="service-content">
                        ...
                        <p>
                            Planning on having a party or an event? Worried about the mess after? You’ve come to the right spot, at Cleanovative we cater for every after ... see more
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mx-auto wow fadeInRight" data-wow-delay=".7s">
                <div class=" single-service">
                    ...
                    <div class="service-content">
                        ...
                        <p>
                            Strata is one of the major maintenance industries for real-estate. At Cleanovative, we make sure our professional team keeps your housing clean and spotless ... see more
                        </p>
                    </div>
                </div>
            </div>
